...
const createSonsMap = (data: FamilyData) => {
    ...
    // Populate children arrays using fatherId (includes all children)
    data.generations.forEach(generation => {
        generation.people.forEach(person => {
            // Any person with a fatherId is considered a child of that father
...
const PersonCard = ({ 
    ...
    const toggleExpand = (e: React.MouseEvent) => {
        // Prevent card expand when clicking buttons inside the card
